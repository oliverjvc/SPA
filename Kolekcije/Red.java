 ...
 * 
 * <p>
 * Ova klasa koristi niz za skladištenje podataka, te je samim tim ogranicena i
 * moguće je da metod za dodavanje elemenata baci izuzetak u slucaju da više
 * nema mesta.
 * </p>
 *
 * @version v1.0.0
 *
 * @param <T>
 *            Tip podataka koji će se cuvati u konkretnoj instanci reda
 *            opsluživanja.
 */
public class Red<T> {
	/**
	...
	/**
	 * Velicina redova za koje nije prosleđen parametar o velicini. Konkretna
	 * vrednost je {@value} .
	 */
	...
	/**
	 * Vraća vrednost elementa na pocetku reda opsluživanja. Ukoliko je red
	 * prazan baca se izuzetak.
	 * 
	 * @return vrednost elementa na pocetku reda opsluživanja
	 */
	public T prvi() {
		if (jePrazan())
	...
	/**
	 * Izbacuje element sa pocetka reda opsluživanja i vraća ga. Ukoliko je red
	 * prazan baca se izuzetak.
	 * 
	 * @return vrednost elementa koji je bio na pocetku reda opsluživanja
	 */
	public T izbaciPrvi() {
		if (jePrazan()) {
			throw new IllegalStateException("Red je prazan");
	 ...
	 * 
	 * @param x
	 *            element koji će biti ubacen na kraj reda
	 */
	 ...
	 * najviše 4 elementa iz reda, tacnije najviše prva dva i poslednja dva,
