 ...
 * 
 * @param <T>
 *            Tip podataka koji će se cuvati u konkretnoj instanci steka.
 */
public class Stek<T> {
	/**
	 ...
	 * 
	 * @param x
	 *            element koji će biti ubacen na vrh steka
	 */
	 ...
	 * najviše 4 elementa sa steka, tacnije najviše prva dva i poslednja dva,
